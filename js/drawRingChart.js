(function($){
	function RingChart(element,settings){
		var container_width,
			skills=[
				{percent:90,name:'Web Visiual Design'},
				{percent:80,name:'Responsive Web Design'},
				{percent:60,name:'Single Page Application'},
				{percent:85,name:'User eXperience'},
				{percent:30,name:'Graphic Design'},
				{percent:75,name:'Mockup'},
				{percent:65,name:'Front-end Programing'},
				{percent:75,name:'3D Animation'},
				{percent:70,name:'Flash Animation'},
				{percent:90,name:'HTML 4/5'},
				{percent:80,name:'CSS 2/3'},
				{percent:60,name:'jQuery'},
				{percent:70,name:'Flash / ActionScript2'},
				{percent:85,name:'Photoshop'},
				{percent:45,name:'Illustrator'},
				{percent:90,name:'Dreamweaver'},
