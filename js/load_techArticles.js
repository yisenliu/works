$.ajax({
	...
	success: function(data){ 
		...
		if(data.articles.length!=0){
			$('.home-technical-panes').append('<hgroup class="slideHeading"><h1>Technical</h1><i class="icon-test-tube icon-clear"></i><h2>Never stop learning. </h2></hgroup><section class="home-technical"></section>' );
			for(var i in data.articles){
				$('.home-technical').append('<article><header><a><img /><h3></h3></a></header><p></p><footer></footer></article>');
				var $el=$('.home-technical > article').eq(i);
