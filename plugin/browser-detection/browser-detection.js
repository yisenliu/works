  ...
  var notSupportedBrowsers = [{
    ...
    BrowserDetection = {
      init: function () {
        ...
        for (i = 0; i < notSupportedBrowsers.length; i++) {
      ...
      getWindowSize: function () {
        ...
        if (window.document.documentElement.clientWidth !== 0) {
          return {
            'width': parseInt(window.document.documentElement.clientWidth, 10),
            'height': parseInt(window.document.documentElement.clientHeight, 10)
          };
        }
        return {
          'width': parseInt(window.document.body.clientWidth, 10),
          'height': parseInt(window.document.body.clientHeight, 10)
        };
      },
      ...
      writeNoticeCode: function () {
        ...
        if (noticeLang === 'custom' && noticeLangCustom !== null) {
          ...
          noticeTextObj = this.noticeText[noticeLang];
      ...
      detectOS: function () {
        var i;
        for (i = 0; i < this.operatingSystems.length; i++) {
